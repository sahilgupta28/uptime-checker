<div class="w-full mt-4 bg-blue-900 px-6 py-3">
    ...
    <form class="w-full py-3" method="POST" action="{{ route('website.create') }}">
        ...
        <div class="flex flex-wrap -mx-3">
            ...
            <input class="appearance-none block w-full bg-gray-300 text-gray-700 border border-gray-500 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Eg: Google" id="title" type="text"  name="title"  autocomplete="current-title" value="{{ old('title') }}">
            ...
            <input class="appearance-none block w-full bg-gray-300 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" id="domain" type="text" class="form-control @error('domain') is-invalid @enderror" name="domain" value="{{ old('domain') }}" autocomplete="domain" autofocus placeholder="Eg: www.google.com">
            ...
            <textarea id="Description" type="text" class="appearance-none block w-full bg-gray-300 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="description" rows="1" placeholder="Write a short note...">{{ old('description') }}</textarea>
