...
<div class="mx-auto h-full justify-center items-center flex">
    <div class="w-10/12 bg-blue-900 rounded-lg shadow-xl p-6">
        <div class="pb-4">
            <div class="text-blue-300 font-bold"> What is uptime checker? </div>
        ...
        <div class="pb-4">
            <div class="text-blue-300 font-bold"> How it works? </div>
        ...
        <div class="pb-4">
            <div class="text-blue-300 font-bold"> How to register on uptime? </div>
        ...
        <div class="pb-4">
            <div class="text-blue-300 font-bold">Can we use any social login/register?</div>
            <div class="text-white">Yes, We have integrated Github login/register. So, You can login login/register via Github.</div>
        </div>
        <div class="pb-4">
            <div class="text-blue-300 font-bold">What is the frequency of testing ping?</div>
        ...
        <div class="pb-4">
            <div class="text-blue-300 font-bold">How I can get a slack hook?</div>
